...
/*
 What is MVU in Flutter?
MVU = Model → View → Update

Model: the app’s state.
View: a pure function of the model.
Update: takes a user action (aka message/event) and the model, returns a new model.

In Flutter, we usually implement this with:
A StatefulWidget holding the Model.
setState() to apply the Update.
The View is just build().
